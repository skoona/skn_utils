...
# - Ref: https://xlinux.nist.gov/dads/HTML/binarySearchTree.html
#        https://ozone.wordpress.com/2006/03/02/binary-search-tree-sauce-ruby-part-1/
...
#
#   def add(value)
#     add_or_create_node(value < @value ? :@left : :@right, value)
#   end
# end
